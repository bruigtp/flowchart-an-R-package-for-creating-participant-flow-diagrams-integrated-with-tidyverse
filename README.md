...
- Vignette's full example to reproduce the flowchart found in the SAFO article: [Example SAFO flowchart](https://bruigtp.github.io/flowchart/articles/flowchart.html#example-2)
